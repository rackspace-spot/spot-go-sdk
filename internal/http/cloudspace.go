...
import (
	...
	"github.com/rackspace-spot/spot-go-sdk/service/cloudspaces"
)

type cloudspaceClient struct {
	baseURL    string
	httpClient *http.Client
}

var _ cloudspaces.Client = (*cloudspaceClient)(nil)

// NewCloudspaceClient creates a new HTTP implementation of the cloudspace client
func NewCloudspaceClient(baseURL string, httpClient *http.Client) cloudspaces.Client {
	if httpClient == nil {
		httpClient = http.DefaultClient
	}
	return &cloudspaceClient{
		baseURL:    baseURL,
...
func (c *cloudspaceClient) ListCloudspaces(ctx context.Context, org string) (*CloudSpaceList, error) {
	if err := validation.ValidateOrgName(org); err != nil {
...
func (c *cloudspaceClient) CreateCloudspace(ctx context.Context, cs CloudSpace) error {
...
func (c *cloudspaceClient) DeleteCloudspace(ctx context.Context, org, name string) error {
...
func (c *cloudspaceClient) GetCloudspace(ctx context.Context, org, name string) (*CloudSpace, error) {
	if err := ValidateOrgName(org); err != nil {
		return nil, fmt.Errorf("invalid organization name: %w", err)
	}
	if err := ValidateResourceName(name); err != nil {
...
func (c *cloudspaceClient) GetCloudspaceConfig(ctx context.Context, namespace, name string) (string, error) {
